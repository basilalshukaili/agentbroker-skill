...
**Tools:** 23 total  -  8 utility tools (no key, unmetered free), 3 premium data tools (free up to daily limit, then $0.02/call), 8 write tools (free email-verified key for 100 ops/day, or credits from $9/1,000 at https://hatchloop.dev/pricing)
